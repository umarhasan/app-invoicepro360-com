...
const fakers = {
  ...
  fakeProducts() {
    const products = [
      { "name": "TechPro Solutions Inc.", "category": "To John Moore" },
      { "name": "Apple Technologies LLC", "category": "To Emily Johnson" },
      { "name": "Oppo Innovations Ltd.", "category": "To Michael Brown" },
      { "name": "Samsung Electronics Co.", "category": "To Sarah Davis" },
      { "name": "Sony Electronics Corp.", "category": "To David Wilson" },
      { "name": "Samsung Display Solutions", "category": "To Jessica Moore" },
      { "name": "Nike Sportswear Ltd.", "category": "To Robert Lee" },
      { "name": "Nike Outdoor Gear Co.", "category": "To Linda Clark" },
      { "name": "Nikon Imaging Technologies", "category": "To James Martinez" },
      { "name": "Sony Imaging Solutions", "category": "To Olivia Garcia" }
    ];
  ...
  fakePaymentHistory() {
    const paymentHis = [
      { type: "Cash", price: 243, date: "03/01/2025", status: "paid" },
      { type: "Credit Card", price: 180, date: "03/03/2025", status: "void" },
      { type: "Clover", price: 310, date: "03/05/2025", status: "paid" },
      { type: "PayPal", price: 99, date: "03/06/2025", status: "void" },
      { type: "Stripe", price: 426, date: "03/08/2025", status: "paid" },
      { type: "Square", price: 145, date: "03/10/2025", status: "paid" },
      { type: "Bank Transfer", price: 378, date: "03/12/2025", status: "void" },
      { type: "Google Pay", price: 298, date: "03/15/2025", status: "paid" },
      { type: "Apple Pay", price: 115, date: "03/18/2025", status: "void" },
      { type: "Venmo", price: 222, date: "03/20/2025", status: "paid" }
    ];
    return _.shuffle(paymentHis);
  },
  ...
  fakeInvoice() {
    const invoice = [
      { name: "Google", price: 299, status: "sent" },
      { name: "Samsung Electronics", price: 150, status: "failed" },
      { name: "Volkswagen Group", price: 425, status: "sent" },
      { name: "Toyota Motor Corporation", price: 230, status: "failed" },
      { name: "Nestlé", price: 120, status: "sent" },
      { name: "Unilever", price: 199, status: "sent" },
      { name: "Tencent", price: 350, status: "failed" },
      { name: "Siemens", price: 180, status: "sent" },
      { name: "Alibaba Group", price: 275, status: "sent" },
      { name: "Amazon", price: 420, status: "failed" },
      { name: "Sony Corporation", price: 99, status: "sent" },
      { name: "L'Oréal", price: 145, status: "failed" },
      { name: "IKEA", price: 80, status: "sent" },
      { name: "Coca-Cola Company", price: 210, status: "sent" },
      { name: "Airbus", price: 390, status: "failed" },
      { name: "BMW Group", price: 275, status: "sent" },
      { name: "HSBC Holdings", price: 310, status: "sent" },
      { name: "Procter & Gamble", price: 130, status: "failed" },
      { name: "Facebook (Meta)", price: 499, status: "sent" }
    ]
    return _.shuffle(invoice);
  },
};
...
for (let i = 0; i < 20; i++) {
  fakerData[fakerData.length] = {
    ...
    invoice: fakers.fakeInvoice(),
    payment: fakers.fakePaymentHistory()
  };
}
